 ...
 * @returns {any}
 */
export function defaultGrowthStages() {
    const ret = wasm.defaultGrowthStages();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function generateSymbol(seed, stage, boost, params, stages) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(seed, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.generateSymbol(ptr0, len0, stage, boost, params, stages);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {number}
 */
export function growthStage(confirmations, stages) {
    const ret = wasm.growthStage(confirmations, stages);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
 ...
 * @returns {any}
 */
export function illuminate(request) {
    const ret = wasm.illuminate(request);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {number}
 */
export function leadingSpaceLength(text) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.leadingSpaceLength(ptr0, len0);
    return ret >>> 0;
}
 ...
 * @param {string} text
 * @param {number | null} [override_len]
 * @returns {number}
 */
export function markLeadLength(text, override_len) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.markLeadLength(ptr0, len0, !isLikeNone(override_len), isLikeNone(override_len) ? 0 : override_len);
    return ret >>> 0;
}
...
export function outerContours(contours) {
    const ret = wasm.outerContours(contours);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 */
export function resetDerivations() {
    wasm.resetDerivations();
}
...
export function setOutlines(outlines) {
    const ret = wasm.setOutlines(outlines);
    if (ret[1]) {
 ...
 * @returns {number}
 */
export function sizeBoost(size, base_size, params) {
    const ret = wasm.sizeBoost(size, base_size, params);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('scriptorium_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
